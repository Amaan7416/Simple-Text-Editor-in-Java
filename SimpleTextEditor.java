...
class SimpleTextEditor implements ActionListener {
    ...
    JTextArea textArea;
    JScrollPane scroll;
    JMenuItem darkTheme, moonLightTheme, defaultTheme, save, open, close, cut, copy, paste, New, selectAll, Feedback,
            documentHelp, fontSize;
    ...
    SimpleTextEditor() {
        ...
        // help menu
        Feedback = new JMenuItem("Reference");
        ...
        Feedback.addActionListener(this); // video help option
